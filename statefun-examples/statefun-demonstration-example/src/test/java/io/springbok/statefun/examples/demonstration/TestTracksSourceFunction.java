...
public final class TestTracksSourceFunction implements SourceFunction<TrackIn> {
	...
	public void run(SourceContext<TrackIn> sourceContext) throws InterruptedException {
		...
		//Timer is important because once the flinksource run shuts down, stateful functions CLOSE mailboxes, so all of the processes can't finish and it throws an error
		Thread.sleep(4000);
	}
