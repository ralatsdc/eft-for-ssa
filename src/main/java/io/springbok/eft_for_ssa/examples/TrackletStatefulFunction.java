...
public class TrackletStatefulFunction implements StatefulFunction {
  ...
  public static final FunctionType TYPE =
      new FunctionType("springbok", "tracklet-stateful-function");

  @Persisted
  private final PersistedValue<Tracklet> trackletState =
      PersistedValue.of("tracklet", Tracklet.class);
  ...
  public void invoke(Context context, Object input) {
    ...
    if (input instanceof RemoveOrbitMessage) {
      ...
      // TODO: potential problem here. If the manager sends a message to an almost expired orbit,
      // and that orbit successfully compares - we have instance of a tracklet being cleared before
